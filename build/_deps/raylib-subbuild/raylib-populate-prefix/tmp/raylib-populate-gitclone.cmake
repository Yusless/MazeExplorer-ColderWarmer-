...
if(EXISTS "C:/Users/Admin/Desktop/ColderWarmer/build/_deps/raylib-subbuild/raylib-populate-prefix/src/raylib-populate-stamp/raylib-populate-gitclone-lastrun.txt" AND EXISTS "C:/Users/Admin/Desktop/ColderWarmer/build/_deps/raylib-subbuild/raylib-populate-prefix/src/raylib-populate-stamp/raylib-populate-gitinfo.txt" AND
  ...
  message(VERBOSE
    ...
    "'C:/Users/Admin/Desktop/ColderWarmer/build/_deps/raylib-subbuild/raylib-populate-prefix/src/raylib-populate-stamp/raylib-populate-gitclone-lastrun.txt'"
  )
  return()
endif()
...
execute_process(
  COMMAND ${CMAKE_COMMAND} -E rm -rf "C:/Users/Admin/Desktop/ColderWarmer/build/_deps/raylib-src"
  RESULT_VARIABLE error_code
  ${maybe_show_command}
)
if(error_code)
  message(FATAL_ERROR "Failed to remove directory: 'C:/Users/Admin/Desktop/ColderWarmer/build/_deps/raylib-src'")
endif()
...
while(error_code AND number_of_tries LESS 3)
  execute_process(
    ...
    WORKING_DIRECTORY "C:/Users/Admin/Desktop/ColderWarmer/build/_deps"
    RESULT_VARIABLE error_code
    ${maybe_show_command}
  )
...
execute_process(
  COMMAND "D:/Git/cmd/git.exe"
          checkout "5.5" --
  WORKING_DIRECTORY "C:/Users/Admin/Desktop/ColderWarmer/build/_deps/raylib-src"
  RESULT_VARIABLE error_code
  ${maybe_show_command}
)
if(error_code)
...
if(error_code)
  message(FATAL_ERROR "Failed to update submodules in: 'C:/Users/Admin/Desktop/ColderWarmer/build/_deps/raylib-src'")
endif()
...
if(error_code)
  message(FATAL_ERROR "Failed to copy script-last-run stamp file: 'C:/Users/Admin/Desktop/ColderWarmer/build/_deps/raylib-subbuild/raylib-populate-prefix/src/raylib-populate-stamp/raylib-populate-gitclone-lastrun.txt'")
endif()
